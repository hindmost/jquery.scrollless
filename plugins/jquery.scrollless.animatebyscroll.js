/**
 * jquery.scrollless.animatebyscroll
 * Scroll animation effect for jquery.scrollless
 * 
 * @version  0.9.0
...
function onPreInit(oOpts) {
    ...
    if ('animatebyscroll' in oOpts && 'nDuration' in oOpts.animatebyscroll)
        nDuration = Math.floor(Number(oOpts.animatebyscroll.nDuration));
    if (oCntr) return;
    oCntr = this;
